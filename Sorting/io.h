 ...
 */
void write(const my_struct& a, const address& path, int num);
void print(const my_struct* a, int num);
...
public:
 ...
 address(const string& path, mode _Mode, wr_mode WR_mode);  // NOLINT(bugprone-reserved-identifier)
