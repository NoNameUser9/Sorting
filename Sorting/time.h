 ...
 */
std::chrono::duration<double, std::ratio<1, 1>> time(void (*f)(dualtype&, const uint16_t& col, const bool&), dualtype& a, const uint16_t& col, const bool& to_low);
/**
 ...
 * \return time in seconds
 */
std::chrono::duration<double, std::ratio<1, 1>> test(void (*f)(dualtype&, const uint16_t& col, const bool&), dualtype& a, const uint16_t& n, const address& path, const uint16_t& col, const bool& to_low);
